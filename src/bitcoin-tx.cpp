...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Doubloons Core doubloons-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  doubloons-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded doubloons transaction") + "\n" +
              "  doubloons-tx [options] -create [commands]   " + _("Create hex-encoded doubloons transaction") + "\n" +
              "\n";
